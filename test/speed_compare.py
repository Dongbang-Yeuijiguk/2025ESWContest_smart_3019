...
#       --pt-model-path "path/to/your/model_traced.pt" \
#       --tflite-model-path "path/to/your/model.tflite" \
...
def main():
    ...
    parser.add_argument("--runs", type=int, default=100, help="속도 측정을 위한 반복 횟수")
